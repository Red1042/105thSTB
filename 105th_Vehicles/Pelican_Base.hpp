		...
		class Components: Components
		{
			class TransportPylonsComponent
			{
				...
				class pylons
				{
					...
					{
						maxweight=300;
						hardpoints[]={"105th_PelicanUnguided","105th_AntiAir","Pelican_Utility"};
					...
					{
						hardpoints[]={"105th_PelicanUnguided","105th_AntiAir","Pelican_Utility","105th_Hellfires","105th_HOTs"};
						UIposition[]={0.1,0.20};
					};
