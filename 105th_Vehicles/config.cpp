...
class cfgVehicles
{
	...
	/*	
	class Land_OPTRE_MedCab;
	class v105_optre_MedCab: Land_OPTRE_MedCab
	{
		editorSubCategory = "HOW_105th_EdCat_Fortifications";
		class TransportItems
		{
			#include "cfg\SupplyPods\ResupplyPodMarineMedical.hpp"
		};
	};
	class Land_optre_milcrate_reachgreencrate;
	class v105_optre_milcrate: Land_optre_milcrate_reachgreencrate
	{
	...
	*/
	...
	class v105_HescoTower: Land_HBarrierTower_F
	{
		scope = 2;
		scopeCurator = 2;
		editorCategory = "HOW_105th_EdCat_Fortifications";
