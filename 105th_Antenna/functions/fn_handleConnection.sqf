...
if(player getVariable["v105_Antenna_Connected",false]) then {
    ...
    _action = [
        ...
        "",
        {
            ...
            _target call v105_Antenna_fnc_handleConnection;
        },
        {true},
        {},
        [parameters],
    ...
    _action = [
        ...
        "",
        {
            player setVariable ["v105_Antenna_Connected",true];
            _target call v105_Antenna_fnc_handleConnection;
            _target spawn v105_Antenna_fnc_handleConnected;
        },
        {true},
        {},
        [parameters],
