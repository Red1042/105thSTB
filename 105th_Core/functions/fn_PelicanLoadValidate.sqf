...
switch true do {
	...
	case (_veh isKindOf "v105_IFV76_B"):
	{
	    _veh attachTo [_pelican,[0,-4.6,.30]];
	    _loaded = true;
	};
	case (_veh isKindOf "v105_APC76_TT"):
	{
	    _veh attachTo [_pelican,[0,-4.6,.25]];
	    _loaded = true;
	};
	case (_veh isKindOf "v105_APC76_MED"):
	{
	    _veh attachTo [_pelican,[0,-4.6,.25]];
	    _loaded = true;
	};
	...
	case (_veh isKindOf "v105_MGS_Timberwolf"):
	{
	    _veh attachTo [_pelican,[0,-4.6,.33]];
	    _loaded = true;
	};
	case (_veh isKindOf "v105_MGS_UP_Timberwolf"):
	{
	...
	case (_veh isKindOf "v105_Fossa_unarmed"):
	{
	    _veh attachTo [_pelican,[0,-4.8,0.30]];
	    _loaded = true;
	};
	case (_veh isKindOf "v105_Fossa_armed"):
	{
	    _veh attachTo [_pelican,[0,-4.8,0.30]];
	    _loaded = true;
	};
	case (_veh isKindOf "v105_Fossa_armed_AT"):
	{
	    _veh attachTo [_pelican,[0,-4.8,0.30]];
	    _loaded = true;
	};
