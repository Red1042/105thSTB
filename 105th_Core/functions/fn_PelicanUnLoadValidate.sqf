		...
		(
			{
				...
				(_x isKindOf "HOW_IFV76_B") OR
				(_x isKindOf "HOW_APC76_TT") OR
				(_x isKindOf "HOW_APC76_MED") OR
				(_x isKindOf "HOW_MGS_Timberwolf") OR
				(_x isKindOf "HOW_MGS_UP_Timberwolf") OR
				(_x isKindOf "B_APC_Tracked_01_CRV_F") OR
				(_x isKindOf "HOW_Fossa_unarmed") OR
				(_x isKindOf "HOW_Fossa_armed") OR
				(_x isKindOf "HOW_Fossa_armed_AT") OR
				...
				(_x isKindOf "v105_SDV_ODST") OR
				(_x isKindOf "v105_SDV_Marine") OR
