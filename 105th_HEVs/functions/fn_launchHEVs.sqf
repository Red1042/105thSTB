/* ----------------------------------------------------------------------------
Function: v105_HEVs_fnc_openHEVMenu
...
[5000,6000,7000,8000] apply {
	_i = _10 lbAdd (format ["%1m",_x]);
	_10 lbSetValue [_i, _x];
};

["Corvette","Halberd","Frigate","Halcyon","Phoenix"] apply {
	_i = _16 lbAdd (format ["%1",_x]);
